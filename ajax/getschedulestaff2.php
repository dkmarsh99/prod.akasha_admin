...
<select id = "sta_staff_id" name="sta_staff_id" style="width: 100%"  class="form-control"   onchange="javascript: upd_attendance('sta_staff_id', this.options[this.selectedIndex].value,<?php echo $sta_id ?>)" >
