...
$uid_client 	= $_REQUEST['uid_client'];
		...
		$sqlst = "SELECT * FROM ".$phxclient_id."_client where uid_client = ". $uid_client;
...
<br>
												...
												<button type="button" onclick="javascript: create_contact(<?php echo $uid_client;?>)" class="btn btn-primary">Create Contact</button>
...
function create_contact(uid_client){
