...
$quote_message2 = "<b>Good news, ".$cont_name. "</b><br><br>We are pleased to submit our quotation, we look forward to hearing from you soon.<br><br> <b>Thank you for giving</b> <span style='color: red'>HOT COPY</span><b> the opportunity to quote this job for you.</b><br><br><br>";
...
?>
	...
	<div class="modal-header"><!-- modal header -->
		...
		<h4 class="modal-title" id="myModalLabel">Send Quote Email
