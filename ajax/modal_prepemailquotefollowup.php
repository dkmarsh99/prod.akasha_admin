...
$quote_message2 = "<b>Hi, ".$cont_name. "</b><br><br>This is a quick follow up regarding our quote. Please let me know if you have any questions. We look forward to hearing from you soon.<br><br> <b>Thank you for giving</b> <span style='color: red'>HOT COPY</span><b> the opportunity to quote this job for you.</b><br><br><br>";

}else{

$quote_message2 = "<b>Hi, ".$cont_name. "</b><br><br>This is a quick follow up regarding our quote. Please let me know if you have any questions. We look forward to hearing from you soon.<br><br> <b>Thank you for the opportunity to quote this job for you.</b><br><br><br>";
...
?>
	...
	<div class="modal-header"><!-- modal header -->
		...
		<h4 class="modal-title" id="myModalLabel">Send Quote Email Follow Up - <?php echo htmlspecialchars($comp_name); ?>
											...
											<fieldset>
												...
												<input type="hidden" name="action" value="contact_send" />
													...
													<div class="col-md-10 col-sm-10">
															<label>Subject *</label>
															<input type="text" 
															id="email_subject" name="contact[first_name]" value="Quote" class="form-control required">
														</div>
														</div>
															<div class="row">
																	<div class="col-md-10 col-sm-10">		
												...
												<button  disabled readonly type="button" onclick="javascript: emailquote(<?php echo $st_id?>)" class="btn btn-primary">Send Email</button>
														<?php
															
														}else{
														?>
														
												<button type="button" onclick="javascript: emailquote(<?php echo $st_id?>)" class="btn btn-primary">Send Email</button>
...
function check_changestatus(status){
	...
	var job_status = status;
				...
				if (job_status == "Quote Draft" || job_status == "Quote Decl"){
...
//			emailfields.reportcompname		 	= sreportcompname;
		...
		//	alert ("reportemailto"+reportemailto);
			...
			if (phxclient_id == "70"){
				...
				var emailurl = "../php/tradesquote70email.php";

			}else if (phxclient_id == "91"){

				var emailurl = "../php/tradesquote91email.php";

			}else if (phxclient_id == "65"){

				var emailurl = "../php/tradesquote65email.php";

				
			}else if (phxclient_id == "102" || phxclient_id == "103" || phxclient_id == "104"){

				alert ("You cant send emails from demo");
				return false();
				
			}else{

				var emailurl = "../php/tradesquoteemail.php";
...
function setemailquoteself(){
	...
	<div class="modal-footer"><!-- modal footer -->
		<button class="btn btn-default" data-dismiss="modal" onclick="javascript: location.reload(); " >Close</button> 
	</div><!-- /modal footer -->
