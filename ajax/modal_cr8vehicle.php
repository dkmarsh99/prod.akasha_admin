...
?>
												...
												<input type="hidden" id="current_state" name="current_state" value="<?php echo $action ?>" />
													...
													<div class="form-group">
														<div class="col-md-8 col-sm-8">
															...
															<input tabindex="0" type="text" id="new_vehicle_rego"   value="" class="form-control required">
														</div>
												...
												<div class="row">
													<div class="form-group">
														<div class="col-md-6 col-sm-6">
															...
															<button type="button" onclick="javascript: create_vehicle()" class="btn btn-primary">Create Vehicle</button>
	...
	<script>
		...
		//	alert (outlet_id+outlet_name);
			...
			var new_vehicle_rego				= document.getElementById("new_vehicle_rego").value;
...
//alert (job_descr+"hello");
			...
			jobfields.new_vehicle_rego				 	= new_vehicle_rego;	

			
				$.ajax({
					url: '../php/cr8vehicle.php',
					type: 'post',
			...
			//			alert (data);
						...
						if (obj.phx_result == ""){
							...
							window.location.replace("../vehicledetaile/?uid_vehicle="+obj.new_id);
							
			//				location.reload();
						}else{
							alert ("Create Vehicle Failed "+data);
						}
